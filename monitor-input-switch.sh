...
if [ "$hostname" = "RG-Mac-Studio" ]; then
    ...
    #Switch keyboard (1)
    sudo /Users/robert.gilkes/Scripts/monitor-input-switch/hidapitester --vidpid 046D:B378 --usage 0x0202 --usagePage 0xff43 --open --length 20 --send-output 0x11,0x00,0x0A,0x1E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
    #Switch mouse (1)
    /Users/robert.gilkes/Scripts/monitor-input-switch/hidapitester --vidpid 046D:B034 --usage 0x0202 --usagePage 0xff43 --open --length 20 --send-output 0x11,0x00,0x0A,0x1E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
